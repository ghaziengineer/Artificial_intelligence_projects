...
#path =r"C:\Users\ghazi\Desktop\REC-INOV Internship\vs\linkedin-web-scraping\chromedriver_win32 (2)\chromedriver.exe"

# download the chromedriver.exe from https://chromedriver.storage.googleapis.com/index.html?path=106.0.5249.21/

driver = webdriver.Chrome(r"C:\Users\ghazi\Desktop\REC-INOV Internship\vs\linkedin-web-scraping\chromedriver_win32 (2)\chromedriver.exe")

# Login
def login():
    login = open(r'C:\Users\ghazi\Desktop\REC-INOV Internship\login.txt') # this is your linkedin account login, store in a seperate text file. I recommend creating a fake account so your real one dosen't get flagged or banned
...
def getProfileURLs(companyName):
    ...
    visibleEmployees = source.find_all('a', class_='scaffold-layout') 
